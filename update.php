...
if (empty($update_url)) {
    $update_url = 'https://github.com/PalstarKe/ispsystem/master.zip';
}
...
$file = pathFixer('system/cache/ispsystem.zip');
$folder = pathFixer('system/cache/ispsystem-' . basename($update_url, ".zip") . '/');
...
<body class="hold-transition skin-blue">
    <div class="container">
                    ...
                    <?php if ($continue || $step == 5) { ?>
                        ...
                        <?php } else if ($step == 5) { ?>
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    Mikropulse has been updated to Version <b><?= $version ?></b>
                                </div>
                            </div>
        ...
        Mikropulse by <a href="https://codevibeisp.co.ke" rel="nofollow noreferrer noopener" target="_blank">Codevibe</a>
        </footer>
    </div>
</body>
