<?php
/* Smarty version 4.3.1, created on 2024-06-25 04:22:47
  from '/home/codevibe/azerin.codevibeisp.co.ke/system/plugin/ui/pppoe_monitor.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_667a1be7119658_47817080',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ce5f3cbf221fd2c2a62029f0710c78081a25a6f9' => 
    array (
      0 => '/home/codevibe/azerin.codevibeisp.co.ke/system/plugin/ui/pppoe_monitor.tpl',
      1 => 1719278562,
      2 => 'file',
    ),
  ),
...
function content_667a1be7119658_47817080 (Smarty_Internal_Template $_smarty_tpl) {
...
>
<?php echo '<script'; ?>
 src="https://cdn.datatables.net/1.10.23/css/jquery.dataTables.min.css"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="https://cdn.datatables.net/buttons/1.7.1/js/dataTables.buttons.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="https://cdn.datatables.net/buttons/1.7.1/css/buttons.dataTables.min.css"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
...
?>
                            <li role="presentation" <?php if ($_smarty_tpl->tpl_vars['r']->value['id'] == $_smarty_tpl->tpl_vars['router']->value) {?>class="active btn btn-outline"<?php }?>>
    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-header">
          <h5 class="modal-title">Trafic for <span id="modalUsername"></span></h5>
        ...
        columns: [
            ...
            },
            {
                ...
                return '<div class="action-icons" style="display: flex; align-items: center;">' +
                      '<i class="fa fa-area-chart view-details" style="color: blue; cursor: pointer;" title="View Trafic" data-username="' + row.username + '" data-id="' + row.id + '"></i> ' +
                      '<i class="fa fa-retweet reconnect-button" style="color: green;cursor: pointer;" title="Reconnect" data-username="' + row.username + '" data-id="' + row.id + '"></i>' +
                      '<i class="fa fa-lock suspend-button" style="color: red;cursor: pointer;" title="Suspend" data-username="' + row.username + '" data-id="' + row.id + '"></i>' +
                      '</div>';
                }
            }
        ],
...
plugin/pppoe_monitor_router_get_ppp_online_users/<?php echo $_smarty_tpl->tpl_vars['router']->value;?>
',
            dataSrc: ''
        }
    });
    ...
    // Handle suspend icon clicks
    $j('#ppp-table tbody').on('click', '.suspend-button', function(e) {
        e.preventDefault();
        var username = $j(this).data('username');
        var id = $j(this).data('id');
    ...
    function viewDetails(id, username) {
        ...
        $j.ajax({
            url: '<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
plugin/pppoe_monitor_router_get_ppp_online_users',
            method: 'GET',
            dataType: 'json',
...
',
     ...
     // Function to handle suspend
    function suspend(id, username) {
        if (confirm('Are you sure you want to suspended user ' + username + '?')) {
            $j.ajax({
                url: '<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
plugin/pppoe_monitor_router_set_disabled/<?php echo $_smarty_tpl->tpl_vars['router']->value;?>
',
                method: 'POST',
                data: { id: id, username: username },
                success: function(response) {
                    if (response.success) {
                        ...
                        alert('Failed to suspended user ' + username + ': ' + response.message);
                    }
                },
                error: function(xhr, textStatus, errorThrown) {
                    alert('Failed to suspended user ' + username + '.');
                    console.error('AJAX error:', textStatus, errorThrown);
                }
            });
        }
